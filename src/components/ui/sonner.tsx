  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "bg-white text-foreground border-border border-2 font-heading shadow-shadow rounded-base flex items-center gap-2.5 p-4 w-[356px] [&:has(button)]:justify-between",
