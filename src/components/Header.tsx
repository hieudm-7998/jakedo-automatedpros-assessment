...
export default function Header() {
  ...
  return (
    <div className='bg-white brand-shadow mx-auto mb-5 px-8 py-5 border-2 rounded w-full max-w-7xl'>
        ...
        <div className='flex gap-2'>
          ...
          >
            ...
            <SelectContent className='bg-white w-[200px]'>
              <SelectGroup>
                <SelectItem className='cursor-pointer' value='character'>
                  Character
                </SelectItem>
                <SelectItem className='cursor-pointer' value='episode'>
                  Episode
                </SelectItem>
                <SelectItem className='cursor-pointer' value='location'>
                  Location
                </SelectItem>
              </SelectGroup>
            </SelectContent>
